...
class ComponentGenerator extends BaseCommand
{
	 ...
	 * @var string
	 */
	protected $description = 'Generates a new Component.';
	 ...
	 */
	protected $options = [
		'--component' => 'Choose the Bootstrap Component.',
	...
	public function run(array $params)
	{
		...
		$this->template  = $this->getViews($this->component, $this->template);


		$this->config->temp['lastQualified'.$this->component.'Name'] = $this->qualifyViewName();
		$this->writeConfig();
